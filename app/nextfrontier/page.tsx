...
function SectionHeading({ eyebrow, title }: { eyebrow: string; title: string }) {
  return (
    <div className="mb-8">
      <div className="camp-label mb-3" data-anim style={{ color: 'var(--camp-red)' }}>{eyebrow}</div>
      <h2 className="camp-display text-3xl sm:text-4xl" data-split>{title}</h2>
    </div>
  );
}
  ...
  return (
    <>
      ...
      <main id="main-content" className="camp flex-1">
        ...
        {/* ---------------- hero ---------------- */}
        <section style={{ background: 'var(--camp-blue)' }} className="overflow-hidden px-4 py-12 sm:py-16">
          <div className="mx-auto max-w-5xl">
            <div className="camp-window">
              ...
              <div className="px-5 py-10 text-center sm:px-10 sm:py-14">
                ...
                <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed" data-anim data-anim-delay="340">
                ...
                <p className="mt-4 text-sm font-semibold" data-anim data-anim-delay="500">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                {
                  icon: Wallet, label: 'Fee',
                  value: <><span data-counter="170" data-counter-prefix="RM">{CAMP.fee}</span> all in</>,
                },
                {
                ...
                <div
                  key={label}
                  className="camp-card camp-card--cream flex items-center gap-3 px-4 py-3"
                  data-anim
        ...
        <section className="px-4 py-20">
          <div className="mx-auto max-w-5xl">
            ...
            <ul className="grid gap-4 sm:grid-cols-2">
              {OUTCOMES.map((item, i) => (
                <li key={item} className="camp-card flex gap-3 px-5 py-4" data-anim data-anim-delay={i * 80}>
        ...
        {/* ---------------- programme ---------------- */}
        <section id="programme" className="scroll-mt-20 px-4 py-20">
          <div className="mx-auto max-w-5xl">
            <SectionHeading eyebrow="The plan" title="Indicative programme" />
            <div className="camp-card camp-card--cream mb-8 flex flex-wrap gap-x-10 gap-y-4 px-6 py-5" data-anim>
              <div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {SCHEDULE.map((day, i) => (
                <div key={day.day} className="camp-card px-6 py-6" data-anim data-anim-delay={i * 140}>
        ...
        {/* ---------------- fee ---------------- */}
        <section className="overflow-hidden px-4 py-20" style={{ background: 'var(--camp-blue)' }}>
          <div className="mx-auto max-w-5xl">
            <div className="camp-tape px-6 py-10 sm:px-10" data-anim>
              <div className="text-center">
                <div className="camp-label mb-2" style={{ color: 'var(--camp-blue)' }}>Everything included</div>
                <div className="camp-display text-6xl sm:text-8xl" style={{ color: 'var(--camp-red)' }}>
                  <span data-counter="170" data-counter-prefix="RM">{CAMP.fee}</span>
                </div>
        ...
        <section className="px-4 py-20">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-6 md:grid-cols-[1.4fr_1fr]">
              ...
              <div className="camp-card camp-card--lilac px-6 py-6" data-anim data-anim-delay="140">
        ...
        {/* ---------------- register ---------------- */}
        <section id="register" className="scroll-mt-20 px-4 py-20" style={{ background: 'var(--camp-lilac)' }}>
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="camp-card camp-card--cream px-6 py-6" data-anim data-anim-delay="140">
        ...
        <section className="overflow-hidden px-4 py-20">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="camp-card overflow-hidden p-3" data-anim>
            ...
            <p className="mt-4 text-center text-sm" data-anim>
        ...
        {/* ---------------- faq ---------------- */}
        <section className="px-4 py-20" style={{ background: 'var(--camp-cream-deep)' }}>
          <div className="mx-auto max-w-3xl">
        ...
        {/* ---------------- contact ---------------- */}
        <section className="px-4 py-20" style={{ background: 'var(--camp-blue)' }}>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-8 text-xs" data-anim style={{ color: 'var(--camp-lilac-deep)' }}>
